...
# ПОЧЕМУ ТУТ ДВЕ ПОХОЖИЕ ФУНКЦИИ. best_match_in_gray выше берёт ОДИН готовый
# эталон-массив; эта берёт ИМЯ и сама перебирает все его варианты и масштабы --
# ровно та же пара, что find_in_gray и find_in_gray_multiscale, и суффикс тот
# же, чтобы пару было видно по названию.
def best_match_in_gray_multiscale(haystack_gray: np.ndarray, name: str, template_dir: str = UI_ASSETS_DIR,
