...
def test_every_task_field_survives():
    ...
    play_mode/extract_after/infinite_wave_limit plus the per-mode extras
    (tower_mode) -- the preset is useless if any of them is dropped or
    coerced."""
    task = {
        ...
        "infinite_wave_limit": 50, "tower_mode": "traitless",
    }
